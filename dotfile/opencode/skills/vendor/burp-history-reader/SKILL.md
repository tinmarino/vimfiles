...
description: 'Reads, searches, and analyzes Burp Suite HTTP proxy history via Burp MCP on localhost:9876. Triggers on "look at Burp history", "what did Burp capture", "search Burp for X", "show me the requests", "read the traffic".'
source: own-tooling
license: MIT
metadata:
