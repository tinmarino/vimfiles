...
description: 'Resends a Burp Repeater request and captures Burp screenshots without focusing the window, via Burp MCP on localhost:9876 plus X11 capture. Triggers on "reenviar/enviar una request de Burp Repeater", "capturar screenshots/pantallazos de Burp", or operating Burp without bringing it to the foreground.'
source: own-tooling
license: MIT
metadata:
