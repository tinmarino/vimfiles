...
description: "Write the English-language bug-bounty report that maximizes payout on HackerOne, Bugcrowd, Intigriti and YesWeHack — impact-first structure, defensible CVSS vector / VRT path, minimal reproduction, PII-safe evidence, and the negotiation playbook for duplicate/informative/N-A/downgrade closures plus mediation. Use when the operator says 'write the H1 report', 'draft this for Bugcrowd', 'pick the VRT category', 'argue severity', 'they downgraded my report', 'this was marked duplicate', 'submit to HackerOne', 'closed as informative', 'request mediation', 'convert this CyScope finding to English', 'escribir el reporte en ingles', 'pasar este hallazgo a bounty', 'me lo cerraron como duplicado', 'pedir mediacion'."
