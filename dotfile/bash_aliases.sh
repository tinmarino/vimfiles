...
# Alma
  ...
  #alias acse2='tmux rename-window ACSE2; ssh user@acse2-gns.internal.example.com -t "source ./.bash_profile; ./.local/bin/tmux new-session -A -s tin"'
  # tmux pipe-pane "$(declare -f tmux_pipe); tmux_pipe \"$(tty)\""
  # shellcheck disable=SC2016  # Expressions
  # Alma_connect(){
  #   tmux rename-window "$1";
  #   ssh user@acse2-gns.internal.example.com -tt '
  #     source ./.bash_profile;
  ...
  alias acse1='alma_connect ACSE1 user@acse1-gns.internal.example.com'
  alias acse2='alma_connect ACSE2 user@acse2-gns.internal.example.com'
  alias ape1='alma_connect APE1 user@ape1-gns.internal.example.com'
  alias ape2='alma_connect APE2 user@ape2-gns.internal.example.com'
  alias hil='alma_connect HIL user@ape-hil-gns.internal.example.com'
  alias tfint='alma_connect HIL user@tfint-gns.internal.example.com'
